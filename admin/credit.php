...
include_once "includes/count.inc.php";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(isset($_POST['submit']) && empty($msg)){
            ...
            // mysqli_stmt_bind_param($stmt2, 'ii', $bal, $id);
            ...
            $route = '701132429';
            if(creditFunds($con, $current_bal, $id, $acct_no, $sender, $bank, $amount, $route, $type, $status, $tr_id, $trnx_date) === TRUE){
                $newDate = date("d - M - Y");
                $subject = 'Credit Alert ['.SITE_NAME_SHORT.']';
                $mail = '
                <!DOCTYPE html>
                <html>
                    <head>
                    ...
                    <body>
                        <section>
                            ...
                            <p>A credit transaction occured with us on your account</p>
                ...
                $successmsg = '<div class="success"> Account successfully credited</div> <p>Redirecting...</p>';        
            }else{
                $msg[] = '<div class="error">Credit failed</div>';
            }
        }
    }
?>
...
<div class="admin-section">
    <div class="balance" style="background: var(--dark-black);">
        <div class="left">
            <p><span class="bold-amount">Credit Account</span></p>
            <p> </p>
        </div>
        <div class="right">
            <p></p>
    ...
    <p>Select a user account you want to add money to...</p>
        ...
        <div class="pin">
            <div class="content">
                ...
                <form action="" method="POST">
                    <p class="align-left" style="font-size: 0.7; margin-bottom: -10px"> Account To Credit</p>
                    ...
                    <span class="input-container"><input type="text" name="sender" id="email" placeholder="Enter name of sender"><i class="details-black fa fa-dice-one"></i></span>
                    ...
                    <button type="submit" name="submit" class="submit-button white">Credit Account</button>
                </form>
            </div>
        </div>
    </div>
